...
class Job
{
    ...
    //Slugify-ing Functions - used for URL Slugging
    public function getCompanySlug()
    {
        return \Ens\JobeetBundle\Utils\Jobeet::slugify($this->getCompany());
    }
 
    public function getPositionSlug()
    {
        return \Ens\JobeetBundle\Utils\Jobeet::slugify($this->getPosition());
    }
 
    public function getLocationSlug()
    {
        return \Ens\JobeetBundle\Utils\Jobeet::slugify($this->getLocation());
    }
}
