...
use EnsJobeetBundle\Entity\Category;
...
class CategoryController extends Controller {
	...
	public function showAction ($slug, $page) {
		...
		return $this->render('EnsJobeetBundle:Category:show.html.twig', array('category' => $category,'last_page' => $last_page,'previous_page' => $previous_page,
			'current_page' => $page,'next_page' => $next_page,'total_jobs' => $total_jobs ));
